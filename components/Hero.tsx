            ...
            <div className="hero-content text-center">
                <div className="body-hero">
                    <WordRotate
                        ...
                        words={["Front End Developer", "UIUX Designer"]}
                    />
                    <h2 className="text-2xl lg:text-3xl font-primary text-white py-6">Hey! I&apos;m <span className="text-accent">Jovi</span>, a <span className="text-accent">front-end</span> web developer and <span className="text-accent">UIUX Designer</span> who loves crafting pixel-perfect and user-friendly interface.</h2>
